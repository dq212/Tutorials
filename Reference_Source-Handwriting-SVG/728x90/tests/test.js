...
describe('zipfile', function() {
	it('should be under 150kb', function() {
		...
		var zip = fs.statSync('Toney_Dell_StickyNotes.zip');
...
describe('static image', function() {
	it('should match dimensions of the creative', function() {
		...
		expect(dimensions.width).toBe(728, '\nIncorrect width on the static image. It should be 728px wide');
		expect(dimensions.height).toBe(90, '\nIncorrect height on the static image. It should be 90px tall');
	});
});
